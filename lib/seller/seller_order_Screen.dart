      ...
      Column(children: [
        ...
        Expanded(
            child: FutureBuilder<List<Map<String, dynamic>>>(
                future: sellerOrdersProvider.fetchOrdersBySellerId(sellerId),
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(15), color: Appcolors.white.withOpacity(0.49), border: Border.all(color: Appcolors.black, width: 0.6)),
                                  child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        ...
                                        Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Image.asset(Appassets.shopSellerimage, height: 70),
                                          )
                                        ])
                                      ]))));
                        });
