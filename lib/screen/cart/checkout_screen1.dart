                ...
                child: GestureDetector(
                    ...
                    child: SingleChildScrollView(
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        GestureDetector(onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const Bottomnavbardesgin())), child: const CustomArrowback()),
                      ...
                      Padding(padding: EdgeInsets.only(top: 18.0, bottom: GetScreenSize.getScreenWidth(context) * 0.045), child: Center(child: Image.asset(Appassets.checkoutimage))),
                      ...
                      Padding(
                          ...
                          child: CaustomText(text: Appstrings.CheckOutCouponCode, color: Appcolors.black, size: GetScreenSize.getScreenWidth(context) * 0.05, maxline: 1, fontWeight: FontWeight.bold)),
                      Container(
